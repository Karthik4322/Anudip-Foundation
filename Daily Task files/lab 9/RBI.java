...
, SavingsAccount, and CurrentAccount. The bank should have a list of accounts and methods
 for adding them. Accounts should be an interface with methods to deposit, withdraw, calculate interest, 
...
System.out.println("The Available types of accounts in Bank"+typesOfAccount);
